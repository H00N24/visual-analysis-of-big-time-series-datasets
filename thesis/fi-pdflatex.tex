...
\thesissetup{
    ...
    keywords    = {time series, dynamic time warping, Feature DTW, clustering, anomaly detection, visual analysis},
    TeXkeywords = {time series, dynamic time warping, Feature DTW, clustering, anomaly detection, visual analysis},
    abstract    = {%
    ...
    thanks      = {%
      I thank my supervisor, doc. Barbora Kozlíková and Mgr. Juraj Pálenik and prof. Helwig Hauser from the VisGroup of the Univesity of Bergen for their guidance and help. I would also like to thank my colleagues from Gauss Algorithmic a.s. for their support and advice.
    },
    bib         =  {
